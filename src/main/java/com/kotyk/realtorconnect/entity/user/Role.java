...
public enum Role {
    ...
    CHIEF_ADMIN(0, List.of(MANAGE_ADMINS, MANAGE_USERS, MANAGE_REALTOR_INFO, SEE_PRIVATE_PHOTOS, ACCESS_TO_ADMIN_PANEL)),
    ADMIN(10, List.of(MANAGE_USERS, MANAGE_REALTOR_INFO, SEE_PRIVATE_PHOTOS, ACCESS_TO_ADMIN_PANEL)),
